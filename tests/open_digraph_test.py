...
class NodeTest(unittest.TestCase):
    ...
    def test_getters(self):
        ...
        self.assertEqual(list(self.n0.parents.values()), [])
        self.assertEqual(self.n0.child_ids, [1])
        self.assertEqual(list(self.n0.children.values()), [2])
    ...
    def test_setters(self):
        ...
        self.assertEqual(list(self.n0.parents.values()), [3, 1, 1])
        self.assertEqual(self.n0.child_ids, [7, 0, 2])
        self.assertEqual(list(self.n0.children.values()), [29, 153, 0])
...
class Open_DigraphTest(unittest.TestCase):
    ...
    def test_getters(self):
        ...
        self.assertEqual(self.g0.nodes_by_ids([1, 4, 0]), [node(1, 'b', {0:1}, {2:2, 5:1}), node(4, 'i1', {}, {0:1}), node(0, 'a', {3:1, 4:1}, {1:1, 2:1})])
